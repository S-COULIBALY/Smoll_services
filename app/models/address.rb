class Address < ApplicationRecord
  ...
  validates :address_type, :complete_address, :carrying_distance, :floor_number, :elevator_capacity,  presence: true

  #validates :elevator, inclusion: {in: [true, false],
  #message: "%{value} is not a valid elevator "}
  #validates :furniture_elevator, inclusion: {in: [true, false],
  #message: "%{value} is not a valid furniture_elevator "}
